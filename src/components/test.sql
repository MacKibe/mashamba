...
SELECT * FROM doc_name_cate;

-- SELECT JSON_ARRAYAGG(JSON_OBJECT("document", document, "id", id, "category", category, "folder", folder, "regno", regno, "area", area, "person", person)) AS aggregated_data FROM document