...
#Formulate the ofice query in 3 parts: images, documents and transcription
with
    ...
    #
    #Compiling the CTE for driving the documents panel
    documents as (
        select
            document.document,
            #
    ...
    #
    #Compile teh CTE for dricing the transption panel
    transcription{
        select
            document.document,
    ...
    office as (
        ...
        from 
            ...
            inner join transcription on tranmscription.document = document.document
